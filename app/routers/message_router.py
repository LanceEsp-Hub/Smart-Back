...
async def get_conversation_messages(
    ...
    try:
        ...
        base_url = f"{os.getenv('API_URL', 'http://localhost:8000')}/uploads/messages/"
            ...
            "messages": [
                {
                    ...
                    "is_read": msg.is_read,
                    "image_url": f"{base_url}{msg.image_url}" if msg.image_url else None
                } for msg in messages
            ]
        }
...
async def upload_message_image(
    ...
    try:
        ...
        return {
            "success": True,
            "filename": filename,
            "file_path": f"/uploads/messages/{filename}"
        }
